...
const About = () => {
  return (
    ...
    >
      <div className="xl:absolute xl:top-0 xl:left-0 xl:max-w-md p-6 rounded-lg bg-base-100 shadow-xl flex flex-col gap-4">
      ...
      <div className="xl:absolute xl:top-0 xl:right-0 xl:max-w-md p-6 rounded-lg bg-base-100 shadow-xl flex flex-col gap-2 xl:-rotate-1">
        <p className="text-3xl font-bold">{"+ 2 ans"}</p>
        <p>{"à accompagner entreprises réunionnaises."}</p>
      </div>
      <div className="xl:absolute xl:top-1/3 xl:right-0 xl:max-w-md p-6 rounded-lg bg-base-100 shadow-xl flex flex-col gap-2">
      ...
      <div className="xl:absolute xl:bottom-0 xl:right-0 xl:max-w-md p-6 rounded-lg bg-base-100 shadow-xl flex flex-col gap-2 xl:-rotate-1">
      ...
      <div className="xl:absolute xl:bottom-0 xl:left-0 xl:max-w-2xl p-6 rounded-lg bg-base-100 shadow-xl xl:rotate-1">
