...
const article = ({ categories, slugs, authors, styles, author, category, categorySlugs, authorSlugs }) => ({
  ...
  title: "Introducing ergonomie.re on the island",
  // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
  description:
    "Ergonomie.re a vocation a amélioré votre espace de travail",
  // An array of categories of the article. It's used to generate the category badges, the category filter, and more.
  categories: [
    categories.find((category) => category.slug === categorySlugs.environnement),
  ],
  ...
  image: {
    ...
    src: "/blog/introducing-ergonomie/image-1.png",
    // The relative URL of the same image to use in the Open Graph meta tags & the Schema Markup JSON-LD.
    urlRelative: "/blog/introducing-ergonomie/image-1.png",
